...
public class GameArena extends JPanel implements Runnable, KeyListener, MouseListener, MouseMotionListener
{
	...
	/**
	 * Create a view of a uk.GameArena.
	 *
	 ...
	 * @param width The width of the playing area, in pixels.
	 * @param height The height of the playing area, in pixels.
	 * @param createWindow Defines if a window should be created to host this uk.GameArena. @see getPanel.
	 */
	...
	/**
	 * Update the size of the uk.GameArena.
	 *
	...
	/**
	 * Set the background of the uk.GameArena window to the specified image file.
	 * The image will be scaled to fit the size of the uk.GameArena
	 *
	 ...
	 * a users application.
	 *
	 * n.b. This should only be called if this uk.GameArena was constructed without its own JFrame
	 *
	 * @return the JPanel containing this uk.GameArena.
	 */
	...
	/**
	 * Close this uk.GameArena window.
	 *
	 */
	public void exit()
	{
		...
		synchronized (this)
		{
			if (!this.exiting)
			{
				...
				for (Object o : things)
				{
					...
					if (o instanceof uk.ac.lancaster.gamearena.Rectangle)
					{
						uk.ac.lancaster.gamearena.Rectangle r = (uk.ac.lancaster.gamearena.Rectangle) o;
		...
		synchronized (this)
		{
			...
			else
			{
				...
				for (int i=0; i<things.size(); i++)
				{
					...
					if (obj instanceof uk.ac.lancaster.gamearena.Rectangle)
						l = ((uk.ac.lancaster.gamearena.Rectangle)obj).getLayer();
	...
	/**
	 * Adds a given uk.Ball to the uk.GameArena.
	 * Once a uk.Ball is added, it will automatically appear on the window.
	 *
	 * @param b the ball to add to the uk.GameArena.
	 */
	...
	/**
	 * Adds a given uk.Rectangle to the uk.GameArena.
	 * Once a rectangle is added, it will automatically appear on the window.
	 *
	 * @param r the rectangle to add to the uk.GameArena.
	 */
	public void addRectangle(uk.ac.lancaster.gamearena.Rectangle r)
	{
		this.addThing(r, r.getLayer());
	}

	/**
	 * Adds a given uk.Line to the uk.GameArena.
	 * Once a uk.Line is added, it will automatically appear on the window.
	 *
	 * @param l the line to add to the uk.GameArena.
	 */
	...
	/**
	 * Adds a given uk.Text object to the uk.GameArena.
	 * Once a uk.Text object is added, it will automatically appear on the window.
	 *
	 * @param t the text object to add to the uk.GameArena.
	 */
	...
	/**
	 * Remove a uk.Rectangle from the uk.GameArena.
	 * Once a uk.Rectangle is removed, it will no longer appear on the window.
	 *
	 * @param r the rectangle to remove from the uk.GameArena.
	 */
	...
	/**
	 * Remove a uk.Ball from the uk.GameArena.
	 * Once a uk.Ball is removed, it will no longer appear on the window.
	 *
	 * @param b the ball to remove from the uk.GameArena.
	 */
	...
	/**
	 * Remove a uk.Line from the uk.GameArena.
	 * Once a uk.Line is removed, it will no longer appear on the window.
	 *
	 * @param l the line to remove from the uk.GameArena.
	 */
	...
	/**
	 * Remove a uk.Text object from the uk.GameArena.
	 * Once a uk.Text object is removed, it will no longer appear on the window.
	 *
	 * @param t the text object to remove from the uk.GameArena.
	 */
	...
	/**
	 * Removes every object that has ever been added to the uk.GameArena. Nothing
	 * should appear on the uk.GameArena window after this has executed.
	 */
	...
	/**
	 * Gets the width of the uk.GameArena window, in pixels.
	...
	/**
	 * Gets the height of the uk.GameArena window, in pixels.
	 ...
	 * @return the current X coordinate of the mouse pointer in the uk.GameArena.
	 */
	...
	/**
	 * Gathers location informaiton on the mouse pointer.
	 * @return the current Y coordinate of the mouse pointer in the uk.GameArena.
	 */
