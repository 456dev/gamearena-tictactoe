 ...
 * This class represents a uk.Line object. When combined with the uk.GameArena class,
 * instances of the uk.Line class can be displayed on the screen.
 */
public class Line 
{
	 ...
	 * @return the X coordinate of the start of this line within the uk.GameArena.
	 */
	 ...
	 * @return the X coordinate of the end of this line within the uk.GameArena.
	 */
	 ...
	 * @return the Y coordinate of the start of this line within the uk.GameArena.
	 */
	 ...
	 * @return the Y coordinate of the end of this line within the uk.GameArena.
	 */
	...
	/**
	 * Obtains the colour of this uk.Line.
	 * @return a textual description of the colour of this uk.Line.
	 */
	...
	/**
	 * Obtains the layer of this uk.Line.
	 * @return the layer of this uk.Line.
	 */
	public int getLayer()
	{
		return layer;
	...
	/**
	 * Constructor. Creates a uk.Line with the given parameters.
	 * @param x1 The x co-ordinate of the start of the uk.Line (in pixels)
	 * @param y1 The y co-ordinate of the start of the uk.Line (in pixels)
	 * @param x2 The x co-ordinate of the end of the uk.Line (in pixels)
	 * @param y2 The y co-ordinate of the end of the uk.Line (in pixels)
	 * @param thickness The width of the uk.Line (in pixels)
	 * @param col The colour of the uk.Line (Permissable colours are: BLACK, BLUE, CYAN, DARKGREY, GREY, GREEN, LIGHTGREY, MAGENTA, ORANGE, PINK, RED, WHITE, YELLOW or ##RRGGBB)
	 * @param lay The layer the uk.Line is to be drawn on. Objects with a higher layer number are always drawn on top of those with lower layer numbers.
	 */
