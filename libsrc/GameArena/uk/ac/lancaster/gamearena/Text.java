 ...
 * This class represents a uk.Text object. When combined with the uk.GameArena class,
 * instances of the uk.Text class can be displayed on the screen to show display
...
public class Text
{
	 ...
	 * @return the X coordinate of this text within the uk.GameArena.
	 */
	 ...
	 * @return the Y coordinate of this text within the uk.GameArena.
	 */
	...
	/**
	 * Obtains the colour of this uk.Text.
	 * @return a textual description of the colour of this uk.Text.
	 */
	...
	/**
	 * Obtains the layer of this uk.Text.
	 * @return the layer of this uk.Text.
	 */
	public int getLayer()
	{
		return layer;
	...
	/**
	 * Moves the current position of this uk.Text to the given co-ordinates
	 * @param x the new x co-ordinate of this uk.Text
	 */
	...
	/**
	 * Moves the current position of this uk.Text to the given co-ordinates
	 * @param y the new y co-ordinate of this uk.Text
	 */
